    ...
    <section className='py-8'>
      ...
      <ul className='styled-list styled-list-primary'>
        ...
        <li className='mb-2'>
          ...
          category, the MWF program was honored for its empowerment of women
          community leaders in strengthening water access, sanitation and
        ...
        <li className='mb-2'>
          ...
          contribution - the provision of hygiene products, hygiene education,
          and installation of infrastructure to improve water access, sanitation
          and hygiene on campus has been lauded by DepEd leaders. At the 5th
          Gawad Kaagapay of the Schools Division Office of Quezon City, the
          Outstanding Stakeholder Award was given to Manila Water Foundation.
        </li>
      </ul>
    </section>
  );
