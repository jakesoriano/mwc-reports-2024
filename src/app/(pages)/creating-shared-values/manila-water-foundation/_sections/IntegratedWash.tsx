...
and reliable water service.
      ...
      <div className='mt-8'>
        <h3 className='text-xl font-bold mb-5'>WASH in Emergencies</h3>
        <div className='md:columns-2 gap-6'>
          <p className='mb-4'>
            Through its AGAPAY: WASH in Emergencies program, Manila Water
            Foundation supported disaster response, recovery and resilience
            phases of vulnerable communities. In February 2024, Manila Water
            Foundation handed over units of Wateroam, Singapore-developed water
            filtration device for Non-East Zone Business Units to share with
            government stakeholders and partners in case raw water supply is
            compromised in a disaster&apos;s aftermath. The units were handed
            over for stakeholders and communities served by Boracay Water,
            Calasiao Water, Calbayog Water, Metro Ilagan in Isabela, Tagum Water
            in Davao del Norte.
          </p>
          <p className='mb-4'>
            To deliver urgently needed clean, potable water after a disaster,
            Manila Water Foundation collaborated with private sector and
            national government agencies. MWF partnered with the Armed Forces of
            the Philippines (AFP) Joint Task Force, the Department of Social
            Welfare and Development (DSWD), the Philippine Air Force, the
            Philippine Coast Guard as well as the Philippine Disaster Resilience
            Foundation (PDRF) and members of the League of Corporate Foundations
            (LCF).
          </p>
          <p className='mb-4'>
          ...
          <p className='mb-4'>
            ...
            (International Name Gaemi), Typhoon Enteng (Yagi), Typhoon Kristine
            (Trami), Manila Water Foundation provided clean, potable water for
            13,140 families or 65,700 individuals and hygiene products for 5,000
            individuals.
          </p>
          <p className='mb-4'>
            Manila Water Foundation was also involved in water supply
            augmentation through water tankers when Bacolod City was hit by El
            Nino, Naga City for a localized water crisis and the Island of
            Siargao for extended power interruption. Manila Water Foundation
            provided 5,736 cubic meters of water via tankers to address critical
            water supply needs in these key locations.
          </p>
          <figure className='mb-5'>
            <Image
