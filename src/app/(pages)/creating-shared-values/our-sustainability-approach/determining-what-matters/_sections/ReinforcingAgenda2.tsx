  ...
  return (
    <div className='flex'>
      <div className='border-r-2 border-blue pr-10 basis-[30%] relative'>
        ...
        <p className='mb-4 font-bold text-secondary'>PROTECTING THE ENVIRONMENT</p>
        ...
        <div>
          ...
          <div className='grid grid-cols-2 gap-4'>
            ...
            />
            <Image
              src='/2024/images/shared-values/our-sustainability-approach/determining-what-matters/sdg-14.png'
              alt='sdg-14'
              width={0}
              height={0}
              sizes='100vw'
            ...
            />
            <Image
              src='/2024/images/shared-values/our-sustainability-approach/determining-what-matters/sdg-15.png'
              alt='sdg-15'
              width={0}
              height={0}
              sizes='100vw'
            ...
            />
            <Image
              src='/2024/images/shared-values/our-sustainability-approach/determining-what-matters/sdg-9.png'
              alt='sdg-9'
              width={0}
              height={0}
              sizes='100vw'
